...
# License
GNU General Public License v3.0. You are free to use, modify, and redistribute this software, provided derivative works are released under the same license and their source is made available.
